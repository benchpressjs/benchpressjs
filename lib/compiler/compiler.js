...
const transforms = {
	...
	EscapedMustache(branch) {
		return t.callExpression(
			t.memberExpression(t.identifier('helpers'), t.identifier('__escape')),
...
function compiler(parsed) {
	...
	return t.functionDeclaration(t.identifier('compiled'), runtimeParams, t.blockStatement([
		t.returnStatement(ConcatStringList(compiled)),
	]));
}

compiler.transforms = transforms;
compiler.runtimeParams = runtimeParams;
