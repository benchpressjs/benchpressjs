...
const testTemplate = fs.readFileSync(path.join(__dirname, '../../tests/templates/source/false-conditional-with-else.tpl')).toString();
// const testTemplate = fs.readFileSync(path.join(__dirname, '../../tmp/flags-detail.tpl')).toString();
